...
- Important principles to follow when testing to gain the most confidence from
  them
  - "The more your tests resemble the way your software is used, the more
    confidence they can give you.
- How to build a test for a React component
- How to trigger interactions and assert that our component acts correctly
- dispatchEvent an how it is oftentimes more useful that .click() because it
  allows us to trigger different kinds of events
  - It also behaves more like an actual click does in the browser
