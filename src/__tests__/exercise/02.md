...
- The basics of using testing-library and more specifically
  react-testing-library
- How testing-library/jest-dom gives a bunch of extra more specific assertions
  on top of the ones Jest has by itself
  - These can be very useful and give more helpful error messages
